...
D3D12Shapes::D3D12Shapes(TCHAR const* const title, int width, int height) : physika::core::Application(title, width, height)
{
...
{
    size_t perPassBufferSize   = graphics::GetSizeWithAlignment(sizeof(physika::PerPassCBData),
                                                                256);  // CBs need to be aligned to 256 byte boundary.
    size_t perObjectBufferSize = graphics::GetSizeWithAlignment(sizeof(physika::PerObjectCBData),
                                                                256);  // CBs need to be aligned to 256 byte boundary.
